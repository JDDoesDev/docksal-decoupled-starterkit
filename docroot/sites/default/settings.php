...
// This should be the last requirement (besides Docksal settings) as it includes
// local.settings.php.
require $dir . "/vendor/acquia/blt/settings/blt.settings.php";

// Signals that this is operating in a Docksal environment and should include
// default Docksal settings.
if (getenv('PROJECT_ROOT') && file_exists(__DIR__ . '/settings/docksal.settings.php')) {
  require __DIR__ . '/settings/docksal.settings.php';
}
