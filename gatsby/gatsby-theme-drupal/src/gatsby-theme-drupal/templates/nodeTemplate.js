...
import Layout from 'gatsby-theme-drupal/src/components/Layout';
...
export default ({ pageContext: { element, nodeName, nodeFields } }) => (
  <Layout headerTitle={element.title}>
    ...
    <iframe
      title="graphiql"
      src={`http://gatsby.genuine.docksal/___graphql?query=%7B%0A%20%20allNode${nodeName}(filter%3A%20%7Bid%3A%20%7Beq%3A%20%22${
        element.id
